...
[_FUNCTION] = LAYOUT_ortho_4x12(
  _______, RGB_TOG, RGB_MOD, RGB_RMOD, _______, _______, _______, _______, KC_UP,   _______, _______, _______,
  _______, RGB_M_P, RGB_M_SW, RGB_M_R, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  KC_CAPS, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, _______, _______, _______, _______, _______,
